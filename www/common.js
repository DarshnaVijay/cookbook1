...
/***/ "8UXC":
/*!****************************************************!*\
  !*** ./src/app/provider/authentication.service.ts ***!
  \****************************************************/
...
/***/ "OBRK":
/*!********************************************!*\
  !*** ./src/app/provider/common.service.ts ***!
  \********************************************/
...
let CommonService = class CommonService {
    constructor(toastCtrl, platform, loadingController) {
    ...
    showLoader(msg) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const loaderToShow = yield this.loadingController.create({
    ...
    hideLoader() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const loaderToShow = yield this.loadingController.dismiss();
        });
    }
};
