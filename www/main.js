...
module.exports = __webpack_require__(/*! F:\Ionic\CookBook\Cookbook\src\main.ts */"zUnb");
...
const environment = {
    production: false,
    firebase: {
        apiKey: 'AIzaSyB8XM4RM-lQjbSODjbo0TV4yOfAHTjFXmc',
        authDomain: 'cookbook-7ca2e.firebaseapp.com',
        databaseURL: 'https://cookbook-7ca2e-default-rtdb.firebaseio.com/',
        projectId: 'cookbook-7ca2e',
        storageBucket: 'cookbook-7ca2e.appspot.com',
        messagingSenderId: '401584725663',
        appId: '1:401584725663:web:1fe0e4ecd1987714c1ccaa',
        measurementId: 'G-9RHFMF6YYY'
    }
};
/*
...
let AppComponent = class AppComponent {
    constructor(toastCtrl, router, statusBar, platform) {
...
AppComponent.propDecorators = {
    routerOutlets: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_5__["ViewChildren"], args: [_ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonRouterOutlet"],] }]
};
...
const routes = [
    ...
    {
        path: 'dishes',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-dishes-dishes-module */ "pages-dishes-dishes-module").then(__webpack_require__.bind(null, /*! ./pages/dishes/dishes.module */ "c8Ai")).then(m => m.DishesPageModule)
    },
    {
        path: 'login',
    ...
    {
        path: 'single-dish',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-single-dish-single-dish-module */ "pages-single-dish-single-dish-module").then(__webpack_require__.bind(null, /*! ./pages/single-dish/single-dish.module */ "0fsa")).then(m => m.SingleDishPageModule)
    },
    {
        path: 'add-dish',
        loadChildren: () => Promise.all(/*! import() | pages-add-dish-add-dish-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-add-dish-add-dish-module")]).then(__webpack_require__.bind(null, /*! ./pages/add-dish/add-dish.module */ "PyVe")).then(m => m.AddDishPageModule)
    },
    {
        path: 'add-notes',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-add-notes-add-notes-module */ "pages-add-notes-add-notes-module").then(__webpack_require__.bind(null, /*! ./pages/add-notes/add-notes.module */ "mUzz")).then(m => m.AddNotesPageModule)
    },
    {
        path: 'search',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-search-search-module */ "pages-search-search-module").then(__webpack_require__.bind(null, /*! ./pages/search/search.module */ "vuQK")).then(m => m.SearchPageModule)
    }
];
